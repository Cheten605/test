...
airline_data = pd.read_csv("airline_data.csv",
                           encoding = "ISO-8859-1", 
                           dtype = {"Div1Airport": str, "Diva1TailNum": str,
...
def get_graph(entered_year):
    ...
    late_fig = px.line(avg_late, x = "Month", y = "LateAircraftDelay", color = "Reporting_Airline", title = "Average security delay time (minutes) by airline")
