...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            options=[{"label" : "Yearly Stastistics", "value": "Yearly Stastistics"},
                     {"label": "Recession Period Statistics", "value": "Recession Period Statistics"}],
            values ="Select Statistics",
    ...
    html.Div(dcc.Dropdown(
            ...
            value='Select-year', placeholder = "Selected-year"
        )),
...
@app.callback(
    Output(component_id='selected-year', component_property='disabled'),
...
def update_output_container(selected_statistics, input_year):
    ...
    elif (input_year and selected_statistics == "Yearly Stastics"):
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        exp_rec= recession_data.groupby("Vehicle_Type")["Adverstising_Expenditure"].sum().reset_index()
        R_chart3 = dcc.Graph(
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        ...
        print([html.Div(className='chart-item', children=[html.Div(children=R_chart1),html.Div(children=R_chart2)],style={'display': 'flex'}),html.Div(className='chart-item', children=[html.Div(children=R_chart3), html.Div(children=R_chart4)],style={'display': 'flex'})])

# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    # Check for Yearly Statistics.                             
elif (input_year and selected_statistics=='Yearly Statistics') :
        yearly_data = data[data['Year'] == input(input_year)]
...
# Plot 2 Total Monthly Automobile sales using line chart.
	...
	# Hint:Use the columns Month and Automobile_Sales.
        mas=data.groupby("Months")["Automobile_Sales"].sum().reset_index()
